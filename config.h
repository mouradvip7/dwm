...
static char *fonts[]          = { "JetBrainsMono Nerd Font:style:medium:size=12", "JoyPixels:pixelsize=12:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	/* { MODKEY|ShiftMask,		XK_backslash,		spawn,		SHCMD("") }, */
 	...
 	{ MODKEY,			XK_s,		spawn,		SHCMD("stremio") },
	...
	{ MODKEY,			XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#' ~/.local/share/larbs/snippets | dmenu -s -l 50 | cut -d' ' -f1)") },
	...
	{ MODKEY,			XK_F11,		spawn,		SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --vf=format=gray16 --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
...
/* 	{ MODKEY|ShiftMask , XK_0 , spawn, SHCMD("sb-kbselect")},*/
